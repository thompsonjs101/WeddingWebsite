            ...
            <div className="border-b pb-5 md:pb-6">
              ...
              <div className="px-3 md:px-6">
                <p className="text-muted-foreground mb-4 text-sm md:text-base">
                  We'll be arriving in Madrid at 7pm and checking into our hotel. We have booked the following accommodation. We have been recommended to stay in the Sevilla area. 
