    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="flex-1 py-20">
        <div className="container mx-auto px-4">
          <h1 className="text-center font-serif text-3xl md:text-4xl text-with-bg mx-auto">Our Wedding Week</h1>
          ...
          <div className="mx-auto mt-12 max-w-4xl space-y-6">
            {/* Wednesday */}
            <div className="border overflow-hidden card-with-bg">
              <div className="px-6 py-4">
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-rose-100 text-rose-500 shadow-sm flex-shrink-0">
                    ...
                    <div className="bg-rose-50 p-4 mb-4">
                      ...
                      <ul className="mt-2 space-y-2 text-muted-foreground">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-rose-400">•</span>
                          <span>
                            This will be a relaxed evening with Spanish tapas, drinks, and a chance to meet everyone
            ...
            <div className="border overflow-hidden card-with-bg">
              ...
              <div className="px-6 pb-6">
                <Card className="bg-white/90">
                  <CardContent className="pt-6">
                    <p className="text-muted-foreground mb-4">
                      We'll be having a relaxed day after the celebrations. We plan to have a late breakfast at the
                      hotel and spend the day reminiscing about the wedding.
                    </p>
                  </CardContent>
                </Card>
              </div>
