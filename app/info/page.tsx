          ...
          <div className="mx-auto mt-10 md:mt-16 max-w-5xl">
            ...
            <div className="mt-6 md:mt-8 grid gap-6 md:gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="p-3 md:p-4">
                ...
                <p className="text-muted-foreground mb-3 text-sm md:text-base">
                  Our bridesmaids will be wearing <strong>light green</strong> dresses. If you&apos;d like to avoid matching them, now you know!
                </p>
                <ul className="space-y-1 md:space-y-2 text-muted-foreground text-sm md:text-base">
                  <li className="flex items-start gap-2">
                    <span className="text-rose-400">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-rose-400">•</span>
                    <span>Semi-formal / cocktail attire</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-rose-400">•</span>
                    <span>
                      <strong>Ladies: absolutely no white</strong> — there&apos;s only one bride, and she&apos;s already picked her dress!
                    </span>
                  </li>
                </ul>
              </div>
