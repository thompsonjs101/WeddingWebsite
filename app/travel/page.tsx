    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="flex-1 py-20">
        <div className="container mx-auto px-4">
          <h1 className="text-center font-serif text-3xl md:text-4xl mx-auto">Travel Information</h1>
          ...
          <div className="mt-16">
            <h2 className="text-center font-serif text-2xl mx-auto">How to Get to Toledo</h2>
              ...
              <div className="grid gap-8 md:grid-cols-3">
                <div className="p-4">
                  <div className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-medium text-lg">Getting to Spain</h3>
                      <p className="text-sm text-muted-foreground">Flying to Madrid</p>
                    </div>
                  </div>
                ...
                <div className="p-4">
                  <div className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Madrid to Toledo</p>
                    </div>
                  </div>
                ...
                <div className="p-4">
                  <div className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-medium text-lg">Private Transport</h3>
                      <p className="text-sm text-muted-foreground">Madrid to Toledo</p>
                    </div>
                  </div>
                  <div>
          ...
          {/* Where to Stay */}
          <div className="mt-16">
            <h2 className="text-center font-serif text-2xl mx-auto">Where to Stay</h2>
            ...
            <div className="mt-8 mx-auto max-w-4xl">
              <div className="p-6">
                <h3 className="text-center text-2xl font-serif mb-2">Cigarral de las Mercedes</h3>
                <p className="text-center text-muted-foreground mb-6">Wedding Venue Accommodation</p>
          ...
          <div className="mt-16">
            <h2 className="text-center font-serif text-2xl mx-auto">Additional Information</h2>
            <div className="mx-auto mt-8 max-w-4xl">
              <div className="grid gap-8 md:grid-cols-3">
                <div className="p-4">
                  <div className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-medium text-lg">Weather</h3>
                      <p className="text-sm text-muted-foreground">Toledo in June</p>
                    </div>
                  </div>
                ...
                <div className="p-4">
                  <div className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Photo Guidelines</p>
                    </div>
                  </div>
                  <p className="text-muted-foreground mb-3">
                ...
                <div className="p-4">
                  <div className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-medium text-lg">Special Needs</h3>
          ...
          <div className="mt-16">
            <h2 className="text-center font-serif text-2xl mx-auto">Destination Information</h2>
            <div className="mx-auto mt-8 max-w-4xl">
              <div className="grid gap-8 md:grid-cols-2">
                <div className="p-4">
                  <div className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-medium text-lg">Madrid Recommendations</h3>
                      <p className="text-sm text-muted-foreground">If you're spending time in the capital</p>
                    </div>
                  </div>
                  <p className="text-muted-foreground mb-4">
                ...
                <div className="p-4">
                  <div className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-medium text-lg">Toledo Recommendations</h3>
                      <p className="text-sm text-muted-foreground">Exploring the historic city</p>
                    </div>
                  </div>
                  <p className="text-muted-foreground mb-4">
